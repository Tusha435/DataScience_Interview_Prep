...
export default function QuestionPage({ params }: QuestionPageProps) {
  const { question, isLoading: questionLoading, error } = useQuestion(params.id)
  const { solutions, isLoading: solutionsLoading, upvoteSolution, downvoteSolution } = useSolutions(params.id)
  const { questions: relatedQuestions, isLoading: relatedLoading } = useRelatedQuestions(params.id)
